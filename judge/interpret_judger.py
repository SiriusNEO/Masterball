...
command = "cp {code_file} ../local/test.mx && cp input.txt ../local/test.in && cd ../local/ && ./irgen.bash && ./dsjit.bash && cp test.out ../judge/output.txt && cd ../judge/"

judge_list = open("testcases/codegen/judgelist1.txt").readlines()
