...
public class Config {
    ...
    public enum Option {Version, Help, Input, LogOutput, ASTOutput, IROutput, OptOutput, ASMOutput, FSyntaxOnly, IROnly, Optimize};
    ...
    static {
        ...
        argSetting.put(Option.IROnly, new Setting("-emit-llvm", false, false));
